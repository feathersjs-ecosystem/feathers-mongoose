...
export declare class MongooseService<Result extends Document = Document, Data = Partial<Result>, ServiceParams extends Params = MongooseAdapterParams, PatchData = Partial<Data>> extends MongooseAdapter<Result, Data, ServiceParams, PatchData> {
